...
python () {
    orca_types = ["orcacore", "orcadev", "orcadbg"]
...
IMAGE_FEATURES:append:orcadev = " dev-pkgs"
IMAGE_FEATURES:append:orcadbg = " dbg-pkgs perf empty-root-password"
...
IMAGE_INSTALL:append:orcadbg = " packagegroup-core-base-utils"

IMAGE_NAME = "${BPN}-${ORCA_TYPE}"
